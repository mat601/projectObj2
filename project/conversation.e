note
	description: "{CONVERSATION}: The conversation main class"
...
feature {NONE} -- Initialization
	...
	make(a_x, a_y:INTEGER_16)
			-- Initialization for `Current' as conversation image path from `a_x' and `a_y'.
		local
		do
			make_image(a_x,a_y,"telechargement.bmp")
		end
